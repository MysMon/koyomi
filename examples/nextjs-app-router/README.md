...
- StackBlitz: `https://stackblitz.com/github/koyomi-cal/koyomi/tree/main/examples/nextjs-app-router`
- CodeSandbox: `https://codesandbox.io/p/sandbox/github/koyomi-cal/koyomi/tree/main/examples/nextjs-app-router`
